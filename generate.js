window.addEventListener("DOMContentLoaded", (event) => {
  ...
  document.getElementById("radio-convocation").checked =
    reason === "convocation";
  document.getElementById("radio-convocation_demarches").checked =
  ...
  document.getElementById("radio-culte_culturel").checked =
    reason === "culte_culturel";
  document.getElementById("radio-achats_culte_culturel").checked =
  ...
  document.getElementById("radio-demenagement").checked =
    reason === "demenagement";
...
function badScriptLoading(event) {
  ...
  script.src = "attestation-deplacement-derogatoire-covid-19/main.9f0a905b.js";
